        ...
        <>
            {news.length > 0 ? <div className='home-page-section' id={id}>
                ...
                <SubStory 
                    title={news[1].title}
                    date={news[1].date}
                    imgSrc={news[1].images[0] ? news[1].images[0].url : "https://static.vecteezy.com/system/resources/thumbnails/001/950/054/small_2x/newspaper-mockup-template-free-vector.jpg"}
                ...
                <SubStory 
                    title={news[2].title}
                    date={news[2].date}
                    imgSrc={news[2].images[0] ? news[2].images[0].url : "https://static.vecteezy.com/system/resources/thumbnails/001/950/054/small_2x/newspaper-mockup-template-free-vector.jpg"}
