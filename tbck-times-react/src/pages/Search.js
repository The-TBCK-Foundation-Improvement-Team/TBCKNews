...
const fetchNews = async (search) => {
  ...
  let url = 'https://newsserviceapi-env.eba-kaahc5te.us-east-2.elasticbeanstalk.com/news/newest';
  ...
  try{
    ...
    if (typeof search === 'string' && search.trim() !== '') {
      ...
      if (matchingCategory) {
        ...
        url = `https://newsserviceapi-env.eba-kaahc5te.us-east-2.elasticbeanstalk.com/news/category/${matchingCategory}`;
      } else {
